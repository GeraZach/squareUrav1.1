# Тут будет плюс подходящий одновременно для сложения двух чисел, так и для стека при операции умножения
# from minusAddOnForPlus import minus

def minus_addon(num_array1, num_array2):
...
def plus(num_array1, num_array2):
    ...
    if sign1 != sign2:
        if sign1 == '-':
            return minus_addon(num_array2, num_array1)

        elif sign2 == '-':
            return minus_addon(num_array1, num_array2)
